    ...
    <div id="home" className="relative bg-white overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Excellence in Education at</span>{' '}
                <span className="block text-brand-600 xl:inline">Foresight Tuitions</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                The most trusted tuition bureau in Anisabad, Patna. We connect dedicated students with qualified home and online tutors to ensure academic success.
              </p>
              ...
              <div className="mt-8 sm:mt-12">
                ...
                <p className="mt-3 text-sm text-gray-400 sm:mt-4">
                  Trusted by 500+ families in Patna
                </p>
              </div>
            </div>
          </main>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          alt="Teacher helping a student with their studies"
        />
        <div className="absolute inset-0 bg-brand-900 opacity-20 mix-blend-multiply lg:hidden"></div>
      </div>
    </div>
  );
};
