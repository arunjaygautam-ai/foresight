        ...
        <div className="bg-gray-50 py-12">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="inline-flex items-center bg-white rounded-full px-6 py-2 shadow-md border border-gray-200">
                    ...
                    <span className="text-gray-800 font-medium">Serving Anisabad, Gardanibagh, Phulwari Sharif & Greater Patna</span>
                </div>
              </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-brand-700 to-brand-900">
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              <span className="block">Struggling with studies?</span>
              <span className="block text-brand-200 text-2xl mt-2">Get a demo class from Foresight today.</span>
            </h2>
